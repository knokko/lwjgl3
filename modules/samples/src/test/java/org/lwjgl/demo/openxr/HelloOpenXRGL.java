...
//                throw new IllegalStateException("Runtime does not support desired Graphics API and/or version");]
            ...
            XrSessionCreateInfo sessionCreateInfo = XrSessionCreateInfo.malloc(stack);
...
//        *requestRestart = true;
    ...
    private void renderFrameOpenXR() {
        try (MemoryStack stack = stackPush()) {
            XrFrameWaitInfo frameWaitInfo = XrFrameWaitInfo.calloc(stack);
            ...
            XrFrameBeginInfo frameBeginInfo = XrFrameBeginInfo.calloc(stack);
            ...
            XrFrameEndInfo frameEndInfo = XrFrameEndInfo.malloc(stack);
            frameEndInfo.set(
