...
public class HelloOpenXRVK {
    ...
    private void initXrActions() {
        try (MemoryStack stack = stackPush()) {
            ...
            XrActionSetCreateInfo ciActionSet = XrActionSetCreateInfo.calloc(stack);
            ...
            this.xrActionSet = new XrActionSet(pActionSet.get(0), xrInstance);
            ...
            XrActionCreateInfo ciActionHandPoses = XrActionCreateInfo.calloc(stack);
            ...
            this.xrHandPoseAction = new XrAction(pActionHandPoses.get(0), xrActionSet);

            XrActionCreateInfo ciActionHandClicks = XrActionCreateInfo.calloc(stack);
            ...
            this.xrHandClickAction = new XrAction(pActionHandClicks.get(0), xrActionSet);
            ...
            XrInteractionProfileSuggestedBinding profileSuggestedBinding = XrInteractionProfileSuggestedBinding.calloc(stack);
            ...
            XrActionSpaceCreateInfo ciActionSpaceLeft = XrActionSpaceCreateInfo.calloc(stack);
            ...
            XrActionSpaceCreateInfo ciActionSpaceRight = XrActionSpaceCreateInfo.calloc(stack);
            ...
            XrSessionActionSetsAttachInfo aiActionSets = XrSessionActionSetsAttachInfo.calloc(stack);
    ...
    private void createXrVkSession() {
        try (MemoryStack stack = stackPush()) {
            ...
            XrGraphicsBindingVulkanKHR graphicsBinding = XrGraphicsBindingVulkanKHR.calloc(stack);
            ...
            XrSessionCreateInfo ciSession = XrSessionCreateInfo.calloc(stack);
            ...
            if (!missingXrDebug) {
                ...
                xrDebugMessenger = new XrDebugUtilsMessengerEXT(pMessenger.get(0), xrInstance);
            }
        }
    }

    private static XrPosef identityPose(MemoryStack stack) {
        XrQuaternionf poseOrientation = XrQuaternionf.calloc(stack);
        poseOrientation.set(0, 0, 0, 1);

        XrVector3f posePosition = XrVector3f.calloc(stack);
        posePosition.set(0, 0, 0);

        return XrPosef.calloc(stack).set(poseOrientation, posePosition);
    }
    ...
    private void createBuffers() {
        try (MemoryStack stack = stackPush()) {
            ...
            VkMemoryAllocateInfo aiSharedMemory = VkMemoryAllocateInfo.calloc(stack);
            ...
            VkMappedMemoryRange sharedMemoryRange = VkMappedMemoryRange.calloc(stack);
            ...
            VkMemoryAllocateInfo aiDeviceMemory = VkMemoryAllocateInfo.calloc(stack);
            ...
            VkCommandBufferAllocateInfo aiCommandBuffer = VkCommandBufferAllocateInfo.calloc(stack);
            ...
            VkCommandBufferBeginInfo biCommandBuffer = VkCommandBufferBeginInfo.calloc(stack);
            ...
            VkFenceCreateInfo ciFence = VkFenceCreateInfo.calloc(stack);
    ...
    private long createBuffer(long size, int usage) {
        ...
        try (MemoryStack stack = stackPush()) {
            VkBufferCreateInfo ciBuffer = VkBufferCreateInfo.calloc(stack);
    ...
    private void createRenderSpace() {
        try (MemoryStack stack = stackPush()) {
            ...
            XrReferenceSpaceCreateInfo ciReferenceSpace = XrReferenceSpaceCreateInfo.calloc(stack);
    ...
    private void createGraphicsPipelines() {
        try (MemoryStack stack = stackPush()) {
            ...
            VkPipelineLayoutCreateInfo ciPipelineLayout = VkPipelineLayoutCreateInfo.calloc(stack);
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            VkShaderModuleCreateInfo ciVertexModule = VkShaderModuleCreateInfo.calloc(stack);
            ...
            VkShaderModuleCreateInfo ciFragmentModule = VkShaderModuleCreateInfo.calloc(stack);
    ...
    private void createGraphicsPipeline(int swapchainIndex, long vertexModule, long fragmentModule) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            VkPipelineVertexInputStateCreateInfo ciVertexInput = VkPipelineVertexInputStateCreateInfo.calloc(stack);
            ...
            VkPipelineInputAssemblyStateCreateInfo ciInputAssembly = VkPipelineInputAssemblyStateCreateInfo.calloc(stack);
            ...
            VkPipelineRasterizationStateCreateInfo ciRasterizationState = VkPipelineRasterizationStateCreateInfo.calloc(stack);
            ...
            // By using calloc, the offset will have a default value of 0, which is desired
            scissor.offset(VkOffset2D.calloc(stack));
            scissor.extent(VkExtent2D.calloc(stack).set(
                this.swapchains[swapchainIndex].width,
                this.swapchains[swapchainIndex].height
            ));

            VkPipelineViewportStateCreateInfo ciViewport = VkPipelineViewportStateCreateInfo.calloc(stack);
            ...
            VkPipelineMultisampleStateCreateInfo ciMultisample = VkPipelineMultisampleStateCreateInfo.calloc(stack);
            ...
            VkPipelineDepthStencilStateCreateInfo ciDepthStencil = VkPipelineDepthStencilStateCreateInfo.calloc(stack);
            ...
            VkPipelineColorBlendStateCreateInfo ciColorBlend = VkPipelineColorBlendStateCreateInfo.calloc(stack);
    ...
    private void createCommandPools() {
        try (MemoryStack stack = stackPush()) {
            ...
            VkCommandPoolCreateInfo ciCommandPoolCopy = VkCommandPoolCreateInfo.calloc(stack);
            ...
            VkCommandPoolCreateInfo ciCommandPoolDrawing = VkCommandPoolCreateInfo.calloc(stack);
    ...
    private void createSwapchains() {
        try (MemoryStack stack = stackPush()) {
            ...
            XrViewConfigurationView.Buffer viewConfigurationViews = XrViewConfigurationView.calloc(numViews, stack);
            ...
            for (int swapchainIndex = 0; swapchainIndex < numViews; swapchainIndex++) {
                ...
                XrSwapchainImageVulkanKHR.Buffer swapchainColorImages = XrSwapchainImageVulkanKHR.calloc(numImages, stack);
                ...
                VkImageCreateInfo ciDepthImage = VkImageCreateInfo.calloc(stack);
                ...
                VkImageSubresourceRange colorSubresourceRange = VkImageSubresourceRange.calloc(stack);
                ...
                VkImageSubresourceRange depthSubresourceRange = VkImageSubresourceRange.calloc(stack);
                ...
                VkMemoryAllocateInfo aiDepthMemory = VkMemoryAllocateInfo.calloc(stack);
                ...
                for (int imageIndex = 0; imageIndex < numImages; imageIndex++) {
                    ...
                    VkImageViewCreateInfo ciImageView = VkImageViewCreateInfo.calloc(stack);
                    ...
                    VkFramebufferCreateInfo ciFramebuffer = VkFramebufferCreateInfo.calloc(stack);
    ...
    private XrCompositionLayerProjectionView.Buffer createProjectionViews(MemoryStack stack, long displayTime) {
        ...
        XrView.Buffer views = XrView.calloc(swapchains.length, stack);
        ...
        for (int viewIndex = 0; viewIndex < swapchains.length; viewIndex++) {
            ...
            XrRect2Di subImageRect = XrRect2Di.calloc(stack);
            // By using calloc, it will automatically get the desired value of 0
            subImageRect.offset(XrOffset2Di.calloc(stack));
            subImageRect.extent(XrExtent2Di.calloc(stack).set(swapchain.width, swapchain.height));

            XrSwapchainSubImage subImage = XrSwapchainSubImage.calloc(stack);
    ...
    private HandStates getHandStates(MemoryStack stack, long time) {
        ...
        XrActionsSyncInfo siActions = XrActionsSyncInfo.calloc(stack);
        ...
        while (true) {
            try (MemoryStack stack = stackPush()) {
                ...
                if (xrSessionState == XR_SESSION_STATE_READY && !startedSession) {
                    XrSessionBeginInfo biSession = XrSessionBeginInfo.calloc(stack);
                ...
                if (
                    ...
                    if (frameState.shouldRender()) {
                        ...
                        for (int swapchainIndex = 0; swapchainIndex < swapchains.length; swapchainIndex++) {
                            ...
                            XrSwapchainImageWaitInfo wiSwapchainImage = XrSwapchainImageWaitInfo.calloc(stack);
                            ...
                            VkClearDepthStencilValue clearDepthValue = VkClearDepthStencilValue.calloc(stack);
                            ...
                            biRenderPass.renderArea(VkRect2D.calloc(stack).set(
                                VkOffset2D.calloc(stack).set(0, 0),
                                VkExtent2D.calloc(stack).set(swapchain.width, swapchain.height)
                            ));
                            ...
                            if (leftHandMatrix != null) {
                                ...
                                XrActionStateGetInfo giAction = XrActionStateGetInfo.calloc(stack);
                    ...
                    XrFrameEndInfo eiFrame = XrFrameEndInfo.calloc(stack);
